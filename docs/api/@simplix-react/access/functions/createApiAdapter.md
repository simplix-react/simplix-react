...
Defined in: [packages/access/src/adapters/api-adapter.ts:77](https://github.com/simplix-react/simplix-react/blob/main/packages/access/src/adapters/api-adapter.ts#L77)
