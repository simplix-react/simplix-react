 ...
 * Source: IANA tz database zone1970.tab
 */
const TIMEZONE_TO_COUNTRY: Record<string, string> = {
  ...
  "America/St_Vincent": "VC", "America/Swift_Current": "CA",
  ...
  "Asia/Brunei": "BN", "Asia/Chita": "RU", "Asia/Colombo": "LK",
  ...
  "Europe/Nicosia": "CY", "Europe/Oslo": "NO", "Europe/Paris": "FR",
  "Europe/Podgorica": "ME", "Europe/Prague": "CZ", "Europe/Riga": "LV",
  "Europe/Rome": "IT", "Europe/Samara": "RU", "Europe/San_Marino": "SM",
  "Europe/Sarajevo": "BA", "Europe/Saratov": "RU", "Europe/Simferopol": "UA",
  ...
  "Pacific/Port_Moresby": "PG", "Pacific/Rarotonga": "CK", "Pacific/Tahiti": "PF",
  "Pacific/Tarawa": "KI", "Pacific/Tongatapu": "TO", "Pacific/Wake": "UM",
  "Pacific/Wallis": "WF",
};

/** Look up ISO 3166-1 country code from IANA timezone ID. */
export function countryFromTimezone(timezone: string): string | undefined {
  return TIMEZONE_TO_COUNTRY[timezone];
}

/**
 * Country of the device's current IANA timezone (an unattended kiosk's zone
 * IS the site's zone), or undefined when the runtime cannot resolve one.
 */
export function countryFromDeviceZone(): string | undefined {
  try {
    const zone = Intl.DateTimeFormat().resolvedOptions().timeZone;
    return zone ? countryFromTimezone(zone) : undefined;
  } catch {
    return undefined;
  }
}
