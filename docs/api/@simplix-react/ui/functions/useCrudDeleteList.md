...
Defined in: [packages/ui/src/crud/delete/use-crud-delete.ts:30](https://github.com/simplix-react/simplix-react/blob/main/packages/ui/src/crud/delete/use-crud-delete.ts#L30)
