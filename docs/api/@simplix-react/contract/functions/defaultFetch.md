...
Defined in: [packages/contract/src/helpers/fetch.ts:67](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/fetch.ts#L67)
