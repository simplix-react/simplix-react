      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            disabled={disabled}
            className={cn(
              "flex h-8 w-full min-w-0 items-center justify-between rounded-md border border-input bg-background px-3 text-sm",
          ...
          >
            {selectedOption ? (
              ...
              <span>{placeholder ?? t("field.selectCurrency")}</span>
            )}
