...
Defined in: [packages/auth/src/stores/session-storage-store.ts:18](https://github.com/simplix-react/simplix-react/blob/main/packages/auth/src/stores/session-storage-store.ts#L18)
