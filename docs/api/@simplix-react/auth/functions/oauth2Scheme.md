...
Defined in: [packages/auth/src/schemes/oauth2-scheme.ts:22](https://github.com/simplix-react/simplix-react/blob/main/packages/auth/src/schemes/oauth2-scheme.ts#L22)
