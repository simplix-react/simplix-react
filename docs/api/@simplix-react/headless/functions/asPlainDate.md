...
[Documentation](../../../README.md) / [@simplix-react/headless](../README.md) / asPlainDate

# Function: asPlainDate()

> **asPlainDate**(`d`): `Date`

Defined in: [parse-date.ts:23](https://github.com/simplix-react/simplix-react/blob/main/parse-date.ts#L23)
