...
Defined in: [packages/contract/src/helpers/path-builder.ts:23](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/path-builder.ts#L23)
