...
Defined in: [packages/ui/src/crud/patterns/use-fade-transition.ts:34](https://github.com/simplix-react/simplix-react/blob/main/packages/ui/src/crud/patterns/use-fade-transition.ts#L34)
