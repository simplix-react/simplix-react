...
Defined in: [packages/auth/src/create-auth-fetch.ts:28](https://github.com/simplix-react/simplix-react/blob/003caac4b599d994962dbe01fbd34d6c7e7deda6/packages/auth/src/create-auth-fetch.ts#L28)
