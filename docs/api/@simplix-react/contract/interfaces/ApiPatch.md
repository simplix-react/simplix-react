...
Defined in: [packages/contract/src/customize-api.ts:29](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/customize-api.ts#L29)
