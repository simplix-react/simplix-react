...
Defined in: [packages/auth/src/stores/memory-store.ts:16](https://github.com/simplix-react/simplix-react/blob/main/packages/auth/src/stores/memory-store.ts#L16)
