...
Defined in: [packages/contract/src/helpers/path-params.ts:35](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/path-params.ts#L35)
