...
Defined in: [packages/ui/src/crud/form/adapt-orval-mutation.ts:20](https://github.com/simplix-react/simplix-react/blob/main/packages/ui/src/crud/form/adapt-orval-mutation.ts#L20)
