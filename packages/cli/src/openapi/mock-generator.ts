...
import type { ResponseAdapterConfig, ResponseAdapterPreset } from "./response-adapter.js";
import { RESPONSE_ADAPTER_PRESETS } from "./presets/response-adapter-presets.js";
...
function resolveAdapterPreset(
  ...
  return RESPONSE_ADAPTER_PRESETS[adapter];
}
