...
Defined in: [packages/contract/src/helpers/case-transform.ts:19](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/case-transform.ts#L19)
