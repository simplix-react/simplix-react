...
Defined in: [packages/auth/src/schemes/api-key-scheme.ts:19](https://github.com/simplix-react/simplix-react/blob/main/packages/auth/src/schemes/api-key-scheme.ts#L19)
