...
Defined in: [packages/access/src/helpers/role-utils.ts:17](https://github.com/simplix-react/simplix-react/blob/main/packages/access/src/helpers/role-utils.ts#L17)
