...
Defined in: [packages/ui/src/crud/form/use-crud-form-submit.ts:125](https://github.com/simplix-react/simplix-react/blob/main/packages/ui/src/crud/form/use-crud-form-submit.ts#L125)
