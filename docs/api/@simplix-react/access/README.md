...
[Documentation](../../README.md) / @simplix-react/access
...
- [AccessExtractResult](interfaces/AccessExtractResult.md)
- [AccessPersistConfig](interfaces/AccessPersistConfig.md)
- [AccessPolicy](interfaces/AccessPolicy.md)
- [AccessPolicyConfig](interfaces/AccessPolicyConfig.md)
- [AccessSnapshot](interfaces/AccessSnapshot.md)
- [AccessUser](interfaces/AccessUser.md)
- [ApiAdapterOptions](interfaces/ApiAdapterOptions.md)
- [JwtAdapterOptions](interfaces/JwtAdapterOptions.md)
- [PermissionMap](interfaces/PermissionMap.md)

## Type Aliases

- [AccessAbility](type-aliases/AccessAbility.md)
...
- [createApiAdapter](functions/createApiAdapter.md)
- [createJwtAdapter](functions/createJwtAdapter.md)
- [createStaticAdapter](functions/createStaticAdapter.md)
