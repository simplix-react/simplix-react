/**
 * ISO 3166-1 alpha-2 country entries with English display names and phone
 * calling codes. English names are the fallback when the runtime lacks
 * Intl.DisplayNames (Hermes); localized names resolve at runtime when
 * available.
 */
...
export const COUNTRIES: CountryEntry[] = [
  ...
  { code: "BA", name: "Bosnia & Herzegovina", callingCode: "387" },
  ...
  { code: "CG", name: "Congo - Brazzaville", callingCode: "242" },
  { code: "CD", name: "Congo - Kinshasa", callingCode: "243" },
  ...
  { code: "HK", name: "Hong Kong SAR China", callingCode: "852" },
  ...
  { code: "MO", name: "Macao SAR China", callingCode: "853" },
  ...
  { code: "PS", name: "Palestinian Territories", callingCode: "970" },
  ...
  { code: "ST", name: "São Tomé & Príncipe", callingCode: "239" },
  ...
  { code: "BL", name: "St. Barthélemy", callingCode: "590" },
  { code: "SH", name: "St. Helena", callingCode: "290" },
  { code: "KN", name: "St. Kitts & Nevis", callingCode: "1" },
  { code: "LC", name: "St. Lucia", callingCode: "1" },
  { code: "MF", name: "St. Martin", callingCode: "590" },
  { code: "PM", name: "St. Pierre & Miquelon", callingCode: "508" },
  { code: "VC", name: "St. Vincent & Grenadines", callingCode: "1" },
  { code: "SD", name: "Sudan", callingCode: "249" },
  { code: "SR", name: "Suriname", callingCode: "597" },
  { code: "SJ", name: "Svalbard & Jan Mayen", callingCode: "47" },
  ...
  { code: "TT", name: "Trinidad & Tobago", callingCode: "1" },
  { code: "TA", name: "Tristan da Cunha", callingCode: "290" },
  { code: "TN", name: "Tunisia", callingCode: "216" },
  { code: "TR", name: "Türkiye", callingCode: "90" },
  { code: "TM", name: "Turkmenistan", callingCode: "993" },
  { code: "TC", name: "Turks & Caicos Islands", callingCode: "1" },
  { code: "TV", name: "Tuvalu", callingCode: "688" },
  { code: "VI", name: "U.S. Virgin Islands", callingCode: "1" },
  ...
  { code: "WF", name: "Wallis & Futuna", callingCode: "681" },
