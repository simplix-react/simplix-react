...
Defined in: [packages/contract/src/helpers/query-builders.ts:30](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/query-builders.ts#L30)
