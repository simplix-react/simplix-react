...
Defined in: [packages/contract/src/helpers/resolve-role.ts:27](https://github.com/simplix-react/simplix-react/blob/main/packages/contract/src/helpers/resolve-role.ts#L27)
