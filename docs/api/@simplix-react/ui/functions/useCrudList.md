...
Defined in: [packages/ui/src/crud/list/use-crud-list.ts:140](https://github.com/simplix-react/simplix-react/blob/main/packages/ui/src/crud/list/use-crud-list.ts#L140)
